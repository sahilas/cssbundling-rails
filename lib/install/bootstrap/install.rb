...
run "pnpm add sass bootstrap bootstrap-icons @popperjs/core postcss postcss-cli autoprefixer nodemon"
...
add_npm_script("build:css", "pnpm build:css:compile && pnpm build:css:prefix")
add_npm_script("watch:css", "nodemon --watch ./app/assets/stylesheets/ --ext scss --exec \\\"pnpm build:css\\\"", false)
